...
user_id=1
ratings = pd.read_csv('ml-1m/ratings.csv', sep=',', names=['userId', 'movieId', 'rating', 'timestamp'],engine = 'python', encoding = 'latin-1')
users = pd.read_csv('ml-1m/users.csv', sep=';', names=['userId', 'gender', 'age', 'occupation', 'zipcode','password'],engine = 'python', encoding = 'latin-1')
movies = pd.read_csv('movies.csv', sep=',', names=['movieId', 'title', 'genres'],engine = 'python', encoding = 'latin-1')
