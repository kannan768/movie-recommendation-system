...
//invalid user
const user_login_failure=(req,res)=>{
    res.render('failure',{heading:"Invalid Credentials",title:"Invalid User"})
}
...
const user_login_post=(req,res)=>{
    ...
    .then(data=>{
        if(data.userId==inputuserid && data.password==inputpassword)
        {
            ...
            res.render('failure',{heading:"Invalid Cred",title:"Home",userid:inputuserid,data:finalstring})
            //res.render('login');
        }
