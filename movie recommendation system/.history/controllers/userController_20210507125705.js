    ...
    .then(data=>{
        if(data.userId==inputuserid && data.password==inputpassword)
        {
            ...
            console.log(inputuserid);
                ...
                var process = spawn('python', ['<div className="" />
                <model4></model4>.py',inputuserid]);
...
var url = "mongodb://localhost:27017/MovieRec";  
MongoClient.connect(url, function(err, db) {  
if (err) throw err;  
var myobj = {userId:"1",movieId:"6033",rating:"5.0",timestamp:"964982703"};  
