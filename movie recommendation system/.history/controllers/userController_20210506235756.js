...
let options = {
  mode: 'text',
  pythonPath: 'C:\Users\Gopi\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Python 3.7',
  pythonOptions: ['-u'], // get print results in real-time
  scriptPath: 'C:\Users\Gopi\Desktop\movierec project\nodelogin\model4.py',
//   args: ['value1', 'value2', 'value3']
};

PythonShell.run('model4.py', options, function (err, results) {
  if (err) throw err;
