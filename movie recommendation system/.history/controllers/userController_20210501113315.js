          ...
          if(data.userId==inputuserid && data.password==inputpassword)
          {
              ...
              console.log(inputuserid);
                ...
                var str=data.toString();
                 var datastring1=str.split("Name: title, dtype: object,");
                 var datastring2=datastring1.split("Name: title, dtype: object]")
                res.render('home',{heading:'Home',title:'Home',data:datastring})
